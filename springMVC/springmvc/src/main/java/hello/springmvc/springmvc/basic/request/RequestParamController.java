...
public class RequestParamController {
     ...
     * @return
     */
    @ResponseBody //@RestController와 같은 기능 : 문자열 반환
    ...
    public String requestParamDefault(@RequestParam(required = false, defaultValue = "guest") String username, @RequestParam(required = true, defaultValue = "-1") int age) {
        log.info("username={}, age={}", username, age);
        return "ok";
    }
