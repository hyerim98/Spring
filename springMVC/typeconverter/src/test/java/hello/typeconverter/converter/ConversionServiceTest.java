...
public class ConversionServiceTest {
    ...
    void conversionService() {
        ...
        Assertions.assertThat(conversionService.convert(ipPortStr, IpPort.class)).isEqualTo(ipPort);
        Assertions.assertThat(conversionService.convert(ipPort, String.class)).isEqualTo(ipPortStr);
    }
}
